...
const NavBar = () => {
    ...
    const organizationId = 'org_TfaKJV07eYX6mbJc';
                ...
                <Container>
                    ...
                    <Collapse isOpen={isOpen} navbar>
                        <Nav className="mr-auto" navbar data-testid="navbar-items">
                            ...
                            {/* <NavItem>
                                <PageLink href={`/api/auth/login?organization=${organizationId}`} className="nav-link" testId="navbar-org-login">
                                    Log In to Atko Org
                                </PageLink>
                            </NavItem> */}
                            {user && (
